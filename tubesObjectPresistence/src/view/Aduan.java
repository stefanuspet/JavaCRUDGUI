 ...
 * @author nayal
 */
public class AduanB extends javax.swing.JFrame {

    /**
     * Creates new form AduanB
     */
    public AduanB() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AduanB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
